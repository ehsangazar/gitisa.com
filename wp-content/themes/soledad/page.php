...
<div class="container container-single-page container-default-page<?php echo $class_small_width; if( $sidebar_default == 'right-sidebar' || $sidebar_default == 'left-sidebar' ): echo ' penci_sidebar '. $sidebar_default; endif; ?>">
